  ...
  return (
    <div className="sidebar fixed left-0 w-56 min-h-screen border-r flex flex-col gap-4 bg-white">
      ...
      <ul className="w-full flex flex-col gap-2 px-2">
        <Link
          to="/"
          className="w-full flex gap-2 justify-start items-center px-4 py-2 font-semibold rounded-full hover:bg-gray-100 focus:bg-gray-100 active:bg-gray-100"
        >
        ...
        <button className="w-full flex gap-2 justify-start items-center px-4 py-2 font-semibold rounded-full hover:bg-gray-100 focus:bg-gray-100 active:bg-gray-100">
