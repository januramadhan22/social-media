...
function Sidebar({ handleOpenHome, handleOpenUser, handleOpenPost }) {
  return (
    <div className="sidebar w-56 min-h-screen border-r flex flex-col gap-4 bg-white">
      ...
      <ul className="w-full flex flex-col gap-2 px-2">
        <button
          ...
          className="w-full flex gap-2 justify-start items-center px-4 py-2 font-semibold rounded-full hover:bg-gray-100"
        >
